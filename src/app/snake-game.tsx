...
export default function SnakeGame() {
  ...
  return (
    <ResponsiveGameLayout bgClass="bg-transparent">
      <div className="flex flex-col md:flex-row items-center justify-center w-full h-full relative">
        ...
        <button
          className="fixed top-6 right-6 px-6 py-3 bg-blue-500 text-white rounded shadow hover:bg-blue-600 text-lg font-bold transition z-20"
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-auto">
          ...
          <div
            className="relative flex items-center justify-center aspect-square bg-white/70 rounded-2xl shadow-xl overflow-hidden"
            style={{
              width: '100%',
